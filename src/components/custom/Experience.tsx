      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold my-3">
            Experience The <i className="text-green-primary">Statistical</i> Power Of Skillup
          </h1>
...
<div className="w-full lg:w-[95%] mx-auto h-auto flex items-center lg:justify-center justify-between  overflow-scroll gap-8 no-scrollbar">
