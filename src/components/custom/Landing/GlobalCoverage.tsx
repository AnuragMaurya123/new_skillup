  ...
  return (
    <div className="w-full h-full lg:h-screen py-5 lg:py-0 lg:mt-32 bg-green-four">
      <div className="w-full lg:w-[80%] relative mx-auto h-[90%]  flex flex-col-reverse lg:flex-row items-center justify-center">
        <div className="relative lg:absolute left-0 top-0 w-full lg:w-[60%] h-full lg:h-[70%] space-y-10 mt-16">
          ...
          <Learner text="took their first step to succeed in their career" num={4532} role="Learners" textcolor="text-black-100" />
        ...
        <div className="relative lg:absolute right-0 xl:scale-125 bottom-0 w-full lg:w-[60%] h-full lg:h-[70%] flex items-center justify-center">
          <img
